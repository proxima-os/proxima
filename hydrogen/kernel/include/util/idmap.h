...
// Allocates an ID and associates it with value. On error returns the negative error code. Possible errors are -ENOMEM
// and -EBUSY. The allocated ID is guaranteed to be the lowest available.
